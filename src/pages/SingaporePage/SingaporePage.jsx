...
export default function SingaporePage() {
  const backgroundImage = "linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.4) ), url(" + Singapore + ")";
  ...
  return (
    ...
    >
      <div className="location-detail-title--container">
        <p className="singapore-city-title">Singapore</p>
        <p className="singapore-country-title">Singapore</p>
      </div>
