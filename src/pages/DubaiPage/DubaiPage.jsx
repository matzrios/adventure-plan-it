...
export default function DubaiPage() {
  const backgroundImage = "linear-gradient( rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0) ), url(" + Dubai + ")";
  ...
  return (
    ...
    >
      <div className="location-detail-title--container">
        <p className="dubai-city-title">Dubai</p>
        <p className="dubai-country-title">Arab Emirates</p>
      </div>
