...
export default function PortlandPage() {
  const backgroundImage = "linear-gradient( rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2) ), url(" + Portland + ")";
  ...
  return (
    ...
    >
      <div className="location-detail-title--container">
        <p className="portland-city-title">Portland</p>
        <p className="location-country-title">USA</p>
      </div>
